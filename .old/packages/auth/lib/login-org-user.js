...
var styles = {
  ...
  orangeAvatar: {
    marginRight: 10,
    color: '#fff',
    backgroundColor: _deepOrange.default[500]
  },
  purpleAvatar: {
    marginRight: 10,
    color: '#fff',
    backgroundColor: _deepPurple.default[500]
  },
  row: {
    display: 'flex',
    paddingTop: 10,
...
}), (0, _core.withStyles)(styles), (0, _recompose.withHandlers)({
...
var _default = enhance(function (_ref5) {
  ...
  return _react.default.createElement(_rx.FindOne, {
    type: "tenant"
  }, function (data) {
    return _react.default.createElement(_reactFinalForm.Form, {
      ...
      render: function render(_ref6) {
        ...
        return _react.default.createElement("form", {
          ...
          variant: "display2"
        }, "Anmeldung"), _react.default.createElement(_Typography.default, {
          variant: "headline"
        }, data.name), _react.default.createElement("br", null), _react.default.createElement(_Typography.default, null, "Geben Sie Ihre E-Mail Adresse an um sich in Ihrem Konto anzumelden oder ein neues zu registrieren."), _react.default.createElement(_Grid.default, {
          container: true,
          spacing: 24
          ...
          onSearch: function onSearch(v) {
            return [{
              id: 1,
              label: 'Benjamin Kniffler',
              ref: 'bk'
            }].filter(function (x) {
              return x.label.indexOf(v) !== -1 || x.ref.indexOf(v) !== -1;
            });
          },
          ...
          type: "submit"
        }, loginType === LOGIN_TYPES.UNREGISTERED ? 'Registrieren' : 'Weiter'))), _react.default.createElement("br", null), _react.default.createElement(_Typography.default, {
          variant: "subheading"
        }, "Zuletzt angemeldet"), _react.default.createElement("div", {
          className: classes.row
        }, _react.default.createElement(_Avatar.default, {
          className: classes.avatar
        }, "bk"), _react.default.createElement(_Avatar.default, {
          className: classes.orangeAvatar
        }, "hk"), _react.default.createElement(_Avatar.default, {
